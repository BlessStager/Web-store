...
<body>
    ...
    <div id="all-news" class="all-news">
        <div class="all-news-header">
            ...
            <div class="content">
                <img class="all-news-btn" onclick="newsChange('p1', 'dec')" src="images/brends/left-arrow.png" alt="left-arrow"/>
                <div><span id="p1" class="p1"></span><span class="p3">/</span><span id="p2" class="p2"></span></div>
                <img class="all-news-btn" onclick="newsChange('p1', 'inc')" src="images/brends/right-arrow.png" alt="right-arrow"/>
            </div>
            <script>
        ...
        <div id="all-news-content" class="all-news-content">
            <div id="all-news-new" class="all-news-new">
                <div class="all-news-new-header">
                    <h3 id="new-title"></h3>
                    <span id="new-date"></span>
                </div>
                <div id="new-content" class="all-news-new-content"></div>
            </div>
        </div>
    </div>
